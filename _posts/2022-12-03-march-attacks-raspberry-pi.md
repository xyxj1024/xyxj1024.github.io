...
| SMT | Everything but I-fetch buffers, <br /> return address stack, <br /> architected register file, <br /> control logic/state, <br /> reorder buffer, store queue, etc. | All contexts concurrently active; no switching
