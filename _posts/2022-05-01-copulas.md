...
tags:               stochastic-mathematics financial-economics
permalink:          /copulas/
...
-    **Kendall's $\tau$**{: style="color: red"}
     $$=\mathbb{P}\{(X_{11} - X_{21})(X_{12} - X_{22}) > 0\} - \mathbb{P}\{(X_{11} - X_{21})(X_{12} - X_{22}) < 0\},$$
where $(X_{11}, X_{12})$ and $(X_{21}, X_{22})$ are independent and identically distributed copies of $(X_{1}, X_{2})$
-    **Spearman's $\rho$**{: style="color: red"}
