...
* If Neither of current <code>n</code>'s children is <code>Nil</code>, replace <code>n</code> with the rightmost node of <code>n</code>'s left child (or equivalently the leftmost node of <code>n</code>'s right child).