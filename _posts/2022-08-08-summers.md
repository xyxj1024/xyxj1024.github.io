---
layout: post
title: "(Unfinished) What did Larry Summers say about the current economic conditions in the U.S.?"
...
$$
\begin{align}
\text{Predicted unemployment rate}_{t} = \alpha \quad + \\
\beta \sum\limits_{0}^{12} \log \text{vacancy rate}_{t - i} \quad + \\
\delta \sum\limits_{0}^{12} \log \text{quits rate}_{t - i} \quad + \\
\gamma\,\text{time trend}_{t} \quad + \\
\theta\,\text{structural break}_{t} \quad + \\
\epsilon_{t},
\end{align}
$$
