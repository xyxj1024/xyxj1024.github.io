...
The correctness of our AVL tree operations depends on how we implement the <code>balance()</code> function. We shall only focus on cases where the absolute value of the balance factors of certain nodes turn to two because if less than two no actions are needed.
...
The <code>rotate_left()</code> and <code>rotate_right()</code> functions are the building blocks of our implementation here. To balance a binary tree whose <code>root</code> node has a balance factor of <code>2</code> or <code>~2</code>, it is useful to consider the following cases:
...
Then, our <code>insert()</code> and <code>remove</code> functions are easy to write:
