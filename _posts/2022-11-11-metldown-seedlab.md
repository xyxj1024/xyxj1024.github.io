...
Please refer to [this post](https://xingjianxuanyuan.github.io/posts/seedlabs/march-attacks) for detailed explanations of Tasks 1 and 2.
...
We put out own secret in the kernel, and then see whether we can use a user-space program to read the secret.
