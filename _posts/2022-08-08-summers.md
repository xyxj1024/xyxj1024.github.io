...
$$\pi_{t} = \underbrace{\sum\limits_{i}(1 - \mathbb{1}_{i \in f, e}) \omega_{i} \pi_{i, t}}_\text{core} + \underbrace{\sum\limits_{i}\mathbb{1}_{i \in f, e} \omega_{i} \pi_{i, t}}_\text{non-core},$$

where $\mathbb{1}_{i \in f, e}$ is the indicator function:

$$
\mathbb{1}_{i \in f, e} =
\begin{cases}
     1, & \text{if equals energy (e) or food (f)},\\
     0, & otherwise.
\end{cases}
$$
