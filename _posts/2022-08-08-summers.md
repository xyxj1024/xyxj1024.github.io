...
$$\pi_{t} = \underbrace{\sum\limits_{i}(1 - \mathbb{I}_{i \in f, e}) \omega_{i} \pi_{i, t}}_\text{core} + \underbrace{\sum\limits_{i}\mathbb{I}_{i \in f, e} \omega_{i} \pi_{i, t}}_\text{non-core},$$
